...
func (this *Client[T]) MarshalAndSendEvent(deviceId string, serviceId string, value interface{}) error {
...
func (this *Client[T]) SendEvent(deviceId string, serviceId string, msg []byte) error {
